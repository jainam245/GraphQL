...
list.addEventListener('itemsUpdated', mirrorToLocalStorage); // event delegation: We listened for the click on the list <ul> but then delegate the click over to the button if that is what was clicked.
